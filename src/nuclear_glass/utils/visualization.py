...
def plot_bnl_vs_time(
    ...
    bnl_true: np.ndarray | None = None, log_scale: bool = True,
...
def plot_prediction_interval(
    ...
    y_true: np.ndarray | None = None, alpha: float = 0.10,
    save_path: Path | None = None,
) -> plt.Figure:
...
def plot_arrhenius(
    temperatures_K: np.ndarray, rates_m_s: np.ndarray, save_path: Path | None = None,
) -> plt.Figure:
